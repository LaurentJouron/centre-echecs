...
class TournamentController:
    ...
    def new_tournament():
        ...
        name, place, start_day, end_date, number_of_round, number_of_players\
            = TournamentView.organize_new_tournament()
        
        tournament = TournamentModel(name, place, start_day, end_date,
